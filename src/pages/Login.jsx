  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#f7f7f7" }}>
      <form onSubmit={handleLogin} style={{ background: "#fff", padding: 32, borderRadius: 12, boxShadow: "0 2px 12px #0002", minWidth: 380, maxWidth: 420, width: "100%", outline: "none" }}>
        ...
        <label style={{ fontWeight: "bold", color: "#222" }}>Nombre</label>
        <input type="text" value={nombre} onChange={e => setNombre(e.target.value)} required style={{ width: "100%", padding: 10, marginBottom: 18, borderRadius: 6, border: "1px solid #bbb", background: "#f7f7f7", fontSize: 16 }} />
